...
import { AnalyzeIcon, LoadingIcon, DiscoveryIcon, CodeIcon, LearnIcon, SocialIcon, EntertainmentIcon, OtherIcon, ChartBarIcon } from './icons';
            ...
            <div>
              ...
              <div className="space-y-4">
                {analysis.trends.map((trend, i) => (
                  <div key={i} className="bg-slate-200 dark:bg-slate-800 p-4 rounded-lg">
