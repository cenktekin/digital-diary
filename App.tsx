...
const translations = {
  tr: {
    ...
    method1Desc: 'Geçmişinizi kolayca <code>.csv</code> dosyasına dönüştürmek için geliştirdiğimiz aracı indirin. İndirdiğiniz klasördeki <strong>gui_gecmis_export.py</strong> uygulamasını çalıştırın, tarayıcınızı seçin ve dosyayı dışa aktarın. Ardından oluşturulan dosyayı aşağıdaki "Dosya Yükle" sekmesinden yükleyin. <a href="https://github.com/cenktekin/digital-diary/raw/main/history-exporter/history-exporter.zip" class="font-bold text-cyan-600 dark:text-cyan-400 hover:underline">[Aracı İndir (history-exporter.zip)]</a>',
  ...
  en: {
    ...
    method1Desc: 'Download our tool to easily export your history to a <code>.csv</code> file. Run the <strong>gui_gecmis_export.py</strong> application in the downloaded folder, select your browser, and export the file. Then, upload the generated file from the "Upload File" tab below. <a href="https://github.com/cenktekin/digital-diary/raw/main/history-exporter/history-exporter.zip" class="font-bold text-cyan-600 dark:text-cyan-400 hover:underline">[Download Tool (history-exporter.zip)]</a>',
